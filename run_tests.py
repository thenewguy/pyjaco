...
def main():
    ...
    if results and results.errors:
        if options.qunit:
            heading = 'Errors Encountered -- Skipped QUnit Tests!'
            print ""
            print "~" * len(heading)
            print heading
            print "~" * len(heading)
        ...
        if not results:
            heading = 'No Results -- Skipped QUnit Tests!'
            print ""
            print "~" * len(heading)
            print heading
            print "~" * len(heading)
            ...
            if results.errors:
                ...
                heading = 'Failures Encountered -- Skipped QUnit Tests!'
                print ""
                print "~" * len(heading)
                print heading
                print "~" * len(heading)
                print ""
            elif results.expectedFailures:
                heading = 'Expected Failures Encountered -- Skipped QUnit Tests!'
                print ""
                print "~" * len(heading)
                print heading
                print "~" * len(heading)
                ...
                print "Writing %d QUnit test%s." % (count, "" if count == 1 else "s")
                i = 1
                for suite in qunit_suites:
                    ...
                    with open(output_test_path, "wb") as fp:
                        ...
                        write_to_qunit(fp, "});")
                        stdout.write("QUnit tests written: %d%% complete.\r" % round(i / count * 100))
                        i += 1
                output = """
<!DOCTYPE html>
<html>
    ...
    <body>
        ...
        <div id="qunit-fixture"></div>
            ...
            """ % (qunit_title, script_tag)
                ...
                stdout.write("QUnit tests written: 100% complete.\n")
